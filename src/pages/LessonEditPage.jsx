...
export default function LessonEditPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await lessonService.update(slug, id, formData);
  ...
  if (loading) {
    return (
      <AppShell title="Edit Lesson" eyebrow="Lesson Management">
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-lg border border-slate-200 bg-white shadow-sm">
          <div className="border-b border-slate-200 p-5">
            <h2 className="text-lg font-bold text-slate-950">Edit Lesson</h2>
          ...
          <form onSubmit={handleSubmit} className="p-5 space-y-5">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-slate-500">MP4, WebM, or OGG. Max 100MB. Leave empty to keep current.</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full text-sm text-slate-600 file:mr-4 file:rounded-lg file:border-0 file:bg-teal-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-teal-700 hover:file:bg-teal-100"
              />
              <p className="mt-1 text-xs text-slate-500">MP3, WAV, or OGG. Max 50MB. Leave empty to keep current.</p>
            </div>
